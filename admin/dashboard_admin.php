    ...
    <div class="col">
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            ...
            <h2 class="card-subtitle mb-2 text-muted">16</h2>
    ...
    <div class="col">
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            ...
            <h2 class="card-subtitle mb-2 text-muted">60</h2>
    ...
    <div class="col">
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            ...
            <h2 class="card-subtitle mb-2 text-muted">20</h2>
...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      <li class="nav-item">
        <a class="nav-link " href="#">Novelku /2</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Komikku /1 </a>
      </li>
    </ul>
  </div>
  <div class="card-body">
    <h5 class="card-title"> Belum Ada Karya Yang Di Terbitkan</h5>
  <img src="../img/upload.jpeg">
